...
organico.addEventListener("click", function () {
    ...
    if (start) {
        ...
        var lineasCodigo = kldc.value / 1000; // Lineas de codigo en miles
        ...
        var esfuerzo = 3.2 * Math.pow(lineasCodigo, 1.05) * fec; // Personas necesarias por mes para llevar adelante el proyecto
...
moderado.addEventListener("click", function () {
    ...
    if (start) {
        ...
        var lineasCodigo = kldc.value / 1000; // Lineas de codigo en miles
        var fec = rssValue * tbdValue * cprValue * rteValue * rmpValue * vmcValue * trcValue * canValue * eanValue * cproValue * esoValue * elpValue * utpValue * uhsValue * rlpValue;
        var esfuerzo = 3.0 * Math.pow(lineasCodigo, 1.12) * fec; // Personas necesarias por mes para llevar adelante el proyecto
        console.log(fec);
...
embebido.addEventListener("click", function () {
    ...
    if (start) {
        ...
        var lineasCodigo = kldc.value / 1000; // Lineas de codigo en miles
        var fec = rssValue * tbdValue * cprValue * rteValue * rmpValue * vmcValue * trcValue * canValue * eanValue * cproValue * esoValue * elpValue * utpValue * uhsValue * rlpValue;
        var esfuerzo = 2.8 * Math.pow(lineasCodigo, 1.20) * fec; // Personas necesarias por mes para llevar adelante el proyecto
...
calcular.addEventListener("click", function () {
    ...
    if (option == 1) {
        ...
        lineasCodigo = kldc.value / 1000; // Lineas de codigo en miles
        ...
        esfuerzo = 3.2 * Math.pow(lineasCodigo, 1.05) * fec; // Personas necesarias por mes para llevar adelante el proyecto
        ...
        if (option == 2) {
            ...
            lineasCodigo = kldc.value / 1000; // Lineas de codigo en miles
            fec = rssValue * tbdValue * cprValue * rteValue * rmpValue * vmcValue * trcValue * canValue * eanValue * cproValue * esoValue * elpValue * utpValue * uhsValue * rlpValue;
            esfuerzo = 3.0 * Math.pow(lineasCodigo, 1.12) * fec; // Personas necesarias por mes para llevar adelante el proyecto
            console.log(fec);
            ...
            if (option == 3) {
                ...
                lineasCodigo = kldc.value / 1000; // Lineas de codigo en miles
                fec = rssValue * tbdValue * cprValue * rteValue * rmpValue * vmcValue * trcValue * canValue * eanValue * cproValue * esoValue * elpValue * utpValue * uhsValue * rlpValue;
                esfuerzo = 2.8 * Math.pow(lineasCodigo, 1.20) * fec; // Personas necesarias por mes para llevar adelante el proyecto
                ...
                document.getElementById("tiempoDesarrollo").innerHTML = Number(tiempoDesarrollo).toFixed(2) + " meses";
                document.getElementById("personasNecesarias").innerHTML = Number(esfuerzo).toFixed(2) + " personas -mes";
                document.getElementById("costoTotal").innerHTML = Number(costoTotalProyecto).toFixed(2) + " meses";
            }
        }
    }
});
